...
function handleAuthResult(authResult) {
  ...
  if (authResult && !authResult.error) {
    ...
    //callScriptFunction("chart");
    callScriptFunction("table");
  } else {
 ...
 * root Drive folder.
 */
function callScriptFunction(info) {
 ...
 */
function updateData(respObj){
  lineChartData.datasets[1].data = respObj.total;
  lineChartData.datasets[2].data = respObj.fixed;
  lineChartData.datasets[3].data = respObj.signup;
